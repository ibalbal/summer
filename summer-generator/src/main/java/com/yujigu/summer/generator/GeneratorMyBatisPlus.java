...
//    private static String BASE_PATH = "C:\\data\\work\\idea\\summer";
    ...
    private static String BASE_PATH = "/Users/y/IdeaProjects/ibalbal/summer";
//    private static String BASE_PATH = "D:/LY/xlsystem";
    ...
    private static String PACKAGE_PARENT = "com.yujigu.summer";
    private static String PACKAGE_SYSTEM = "oauth";
    private static String PACKAGE_ENTITY = "common.entity.oauth";
    ...
    public static void main(String[] args) {
        SymGenerator.build(DATA_URL, DATA_USER_NAME, DATA_PASSWORD, OUT_PATH, PACKAGE_PARENT, PACKAGE_SYSTEM, PACKAGE_ENTITY, TABLES, OUT_PATH_ENTITY,OUT_PATH_SERVICE, OUT_PATH_CONTROLLER, true);
    }
}
